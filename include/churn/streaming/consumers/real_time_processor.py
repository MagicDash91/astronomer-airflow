...
from streaming.schemas.customer_event import (
    ...
    KAFKA_TOPICS, KAFKA_CONSUMER_CONFIG, KAFKA_PRODUCER_CONFIG
)
...
class RealTimeChurnPredictor:
    ...
    def __init__(self, model_path: str = None):
        self.model_path = model_path or "/usr/local/airflow/include/churn/models/churn_model.pkl"
        self.metadata_path = model_path or "/usr/local/airflow/include/churn/models/model_metadata.pkl"
        ...
        try:
            self.redis_client = redis.Redis(host='churn-redis', port=6379, decode_responses=True)
...
class RealTimeStreamProcessor:
    ...
    def __init__(self, consumer_config: Dict[str, Any] = None, producer_config: Dict[str, Any] = None):
        self.consumer_config = consumer_config or KAFKA_CONSUMER_CONFIG.copy()
        self.producer_config = producer_config or KAFKA_PRODUCER_CONFIG.copy()
